...
Build to this floor without announcing it. The design detector (the project hook, `node .cursor/skills/impeccable/scripts/detect.mjs --json <file>`, or `audit`) verifies most of it mechanically; any finding it raises is a defect to fix, not a suggestion.
