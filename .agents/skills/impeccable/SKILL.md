...
- **Hand-drawn / sketchy SVG illustrations.** Crude multi-path scenes meant to depict a tangible subject read as amateurish, not whimsical. If you can't render the scene with real assets, ship no illustration.
- **Decorative stripe or grid backgrounds** built from repeating/linear gradients, unless the surface is an actual canvas, map, blueprint, or measurement tool. Use product structure, real artifacts, or a plain surface instead.
